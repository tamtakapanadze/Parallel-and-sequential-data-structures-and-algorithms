...
structure FastHashRand :> RANDOM210 =
struct
  ...
  fun split r =
    (hashWord r, (hashWord (r+0w1), hashWord (r+0w2)))
  ...
  fun split3 r =
    (hashWord r, (hashWord (r+0w1), hashWord (r+0w2), hashWord (r+0w3)))
  ...
  val intp =
    ...
    | NONE => (TextIO.output (TextIO.stdErr,
                 "[ERR] FastHashRand needs a constant Int.precision.\n");
